...
- Your newest ask under the box with status: judging, live, held, or failed with retry. One card with an X. Signed in it stays until you close it or ask again and links to your history on `/me`. Signed out, a live ask drains for four seconds, then slides toward the wall and fades; hover holds it
